...
func (h *Handler) HandleCreateTask(w http.ResponseWriter, r *http.Request) {
	...
	params := sqlc.CreateTaskParams{
		...
		Status:      sqlc.NullTaskStatus{TaskStatus: sqlc.TaskStatus(payload.Status), Valid: payload.Status != ""},
		Priority:    sqlc.NullPriority{Priority: sqlc.Priority(payload.Priority), Valid: payload.Priority != ""},
		DueDate:     dueDate,
